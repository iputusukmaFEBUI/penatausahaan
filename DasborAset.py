...
st.markdown("Dasbor ini belum menyajikan informasi yang bersifat forward-looking. Halaman Top Figure menyajikan total nilai aset, total PNBP dan total spending (capital expenditure dan operating expenditure) dan visualisasi atas top-10 atas indikator tersebut.")
st.markdown("Halaman Analitik PNBP menyajikan total PNBP, rerata PNBP tahunan sepanjang holding period, dan gross income multiplier yang merupakan perbandingan antara rerata PNBP tahunan dengan nilai aset sebelum akumulasi penyusutan. Halaman ini juga menyajikan visualisasi atas time-series PNBP dari tahun 2016 s.d. 30 Juni 2024.")
